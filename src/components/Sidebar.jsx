...
export default function Sidebar({ open, setOpen }) {
  ...
  return (
    <>
      ...
      <div className={`fixed top-0 right-0 z-40 w-64 h-full bg-white dark:bg-slate-900 shadow-2xl transform transition-all duration-500 ease-in-out lg:translate-x-0 lg:static lg:inset-0 sidebar ${open ? 'translate-x-0' : 'translate-x-full'}`}>
        <div className="flex items-center justify-between h-20 px-6 border-b border-gray-200 dark:border-slate-700">
              ...
              <Link
                ...
                className={`group flex items-center px-4 py-3 text-sm font-medium rounded-xl transition-all duration-300 ease-out ${
                  isActive
                    ...
                    : 'text-gray-600 dark:text-slate-300 hover:text-gray-900 dark:hover:text-white hover:bg-gray-100 dark:hover:bg-slate-700 hover:transform hover:scale-105'
                }`}
              >
        ...
        <div className="absolute bottom-0 left-0 right-0 p-4 border-t border-gray-200 dark:border-slate-700">
          <div className="flex items-center space-x-3 p-3 rounded-xl bg-gray-100 dark:bg-slate-800">
